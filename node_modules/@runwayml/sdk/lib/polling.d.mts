...
import { TaskRetrieveResponse } from "../resources/tasks.mjs";
...
export declare function wrapAsWaitableResource<T extends {
    id: string;
}>(client: RunwayML): (responsePromise: APIPromise<T>, skipInitialWait?: boolean) => APIPromiseWithAwaitableTask<T>;
