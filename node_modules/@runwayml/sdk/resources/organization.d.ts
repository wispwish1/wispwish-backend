...
export interface OrganizationRetrieveUsageResponse {
     ...
     */
    models: Array<'act_two' | 'eleven_multilingual_v2' | 'gemini_2.5_flash' | 'gen3a_turbo' | 'gen4_aleph' | 'gen4_image' | 'gen4_image_turbo' | 'gen4_turbo' | 'upscale_v1' | 'veo3'>;
...
export declare namespace OrganizationRetrieveUsageResponse {
    ...
    namespace Result {
        interface UsedCredit {
             ...
             */
            model: 'act_two' | 'eleven_multilingual_v2' | 'gemini_2.5_flash' | 'gen3a_turbo' | 'gen4_aleph' | 'gen4_image' | 'gen4_image_turbo' | 'gen4_turbo' | 'upscale_v1' | 'veo3';
        }
    }
}
